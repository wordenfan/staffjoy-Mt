...
public class MailSendService {
    ...
    private static final ILogger logger = SLoggerFactory.getLogger(MailSendService.class);
...
//            logger.error("appName===========", appName);
            ...
            if (!req.getTo().endsWith(MailConstant.STAFFJOY_EMAIL_SUFFIX)) {
                logger.warn("InterceptedMM sending due to non-production environment.");
                return;
            }
        }
        ...
        try {
            ...
            System.out.println("ErrCode : " + ex.getErrCode());
